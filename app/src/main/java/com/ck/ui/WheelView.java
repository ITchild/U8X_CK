...
import com.ck.ui.adapter.WheelAdapter;
import com.ck.ui.listener.OnWheelChangedListener;
import com.ck.ui.listener.OnWheelScrollListener;
...
public class WheelView extends View {
    ...
    private void initResourcesIfNecessary() {
        ...
        if (centerDrawable == null) {
            centerDrawable = getContext().getResources().getDrawable(R.drawable.btninit);
        }
        ...
        setBackgroundResource(R.drawable.btnpressed);
    }
    ...
    private void drawValue(Canvas canvas) {
        ...
        if (valueLayout != null) {
            canvas.save();
            canvas.translate(itemsLayout.getWidth()/2+LABEL_OFFSET/2+itemsWidth/4, bounds.top + scrollingOffset);
    ...
    private void drawItems(Canvas canvas) {
        ...
        canvas.translate(itemsLayout.getWidth()/2+LABEL_OFFSET/2+itemsWidth/4, - top + scrollingOffset);
