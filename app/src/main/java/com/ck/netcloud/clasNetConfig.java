...
public class clasNetConfig {       
	...
	public String strServerPath = "";     //服务器文件路径名
	public String strClientFilePath = ""; //本地文件路径名
	...
	public int nDataType = 0;        //数据 

	public String strDevID = "01234567890123456";  //设备ID（长度17） 在仪器编号的基础上，增加6位长度
